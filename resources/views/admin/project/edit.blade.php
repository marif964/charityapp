...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('admin.project-list') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col mr-2">
                                        <div class="mb-3"><label class="form-label" for="description">Description</label><textarea class="form-control" id="description" name="description">{{ $project->description }}</textarea></div>
                                    </div>

                                    <div class="col mr-2">
                                        <div class="mb-3"><label class="form-label" for="summary">Summary</label><textarea class="form-control" id="summary" name="summary">{{ $project->summary }}</textarea></div>
                                    </div>

                                    <div class="col mr-2">
                                        <div class="mb-3"><label class="form-label" for="challenge">Challenge</label><textarea class="form-control" id="challenge" type="text"  name="challenge">{{ $project->challenge }}</textarea></div>
                                    </div>
                                </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col mr-2">
                                        <div class="mb-3"><label class="form-label" for="solution">Solution</label><textarea class="form-control" id="solution" type="text" name="solution">{{ $project->solution }}</textarea></div>
                                    </div>
