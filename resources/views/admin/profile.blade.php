...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('admin.home') }}" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.update-profile') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col mr-2">
                                         <div class="mb-3"><label class="form-label" for="name">Name</label><input class="form-control" value="{{ $profile->name }}" id="name" name="name" type="text" ></div>   
                                    </div>
