        ...
        <div class="col-md-6 pe-0">
            <div id="lgcarousel" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner">
                ...
                @php($rankOneProjects = getCategoryProjectsByRank($categoryId, 1))
                ...
                <div class="carousel-item {{ $k == 0 ?'active' :''}}">
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    ...
                    <a class="btn btn-outline-warning" href="{{ route('project-detail', ['project_id' => $id]) }}">Donate</a>
                     @endif
                      @endif
                  </div>
                </div>
                ...
                @else
                        ...
                        <div class="carousel-item active">
                          <img src="{{ asset('assets/images/slider-placeholder.png') }}" class="d-block w-100" alt="...">
                          <div class="carousel-caption d-none d-md-block">
                             <p class="text-secondary">Not Available Rank 1 Projects</p>
                          </div>
                       </div>
                @endif  
           ...
           <div class="row">
              <div class="col-md-6 pe-0 pb-1">
                 <div id="mdOneCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    @php($rankTwoProjects = getCategoryProjectsByRank($categoryId, 2))
                    ...
                    @if(sizeof($rankTwoProjects) > 0)
                        ...
                        <div class="carousel-item {{ $k == 0 ?'active' :''}}">
                            ...
                            @endif
                          <div class="carousel-caption d-none d-md-block">
                            <h2 class="text-white">{{ ucwords($rankTwoProj->title) }}</h2>
                             @if(!Auth::guard('web')->check())
                    ...
                    @else
                        ...
                        <div class="carousel-item active">
                          ...
                          <div class="carousel-caption d-none d-md-block">
                             ...
                             <p class="text-secondary">Not Available Rank 2 Projects</p>
                          </div>
                       </div>
                    @endif   
                    </div>
              ...
              <div class="col-md-6 px-1 pb-1">
                 <div id="mdTwocarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                       <@php($rankThreeProjects = getCategoryProjectsByRank($categoryId, 3))
                    ...
                    @if(sizeof($rankThreeProjects) > 0)
                        ...
                        <div class="carousel-item {{ $k == 0 ?'active' :''}}">
                            ...
                            @endif
                          <div class="carousel-caption d-none d-md-block">
                            <h2 class="text-white">{{ ucwords($rankThreeProj->title) }}</h2>
                            @if(!Auth::guard('web')->check())
                    ...
                    @else
                        ...
                        <div class="carousel-item active">
                          ...
                          <div class="carousel-caption d-none d-md-block">
                             ...
                             <p class="text-secondary">Not Available Rank 3 Projects</p>
                          </div>
                       </div>
                    @endif  
                    </div>
           ...
           <div class="row">
              <div class="col-md-6 pe-0 pb-1">
                 <div id="mdThreeCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                       @php($rankFourProjects = getCategoryProjectsByRank($categoryId, 4))
                    ...
                    @if(sizeof($rankFourProjects) > 0)
                        ...
                        <div class="carousel-item {{ $k == 0 ?'active' :''}}">
                            ...
                            @endif
                          <div class="carousel-caption d-none d-md-block">
                            <h2 class="text-white">{{ ucwords($rankFourProj->title) }}</h2>
                            @if(!Auth::guard('web')->check())
                    ...
                    @else
                        ...
                        <div class="carousel-item active">
                          ...
                          <div class="carousel-caption d-none d-md-block">
                             ...
                             <p class="text-secondary">Not Available Rank 4 Projects</p>
                          </div>
                       </div>
                    @endif  
                    </div>
              ...
              <div class="col-md-6 px-1 pb-1">
                 <div id="mdFourCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      @php($rankFiveProjects = getCategoryProjectsByRank($categoryId, 5))
                    ...
                    @if(sizeof($rankFiveProjects) > 0)
                        ...
                        <div class="carousel-item {{ $k == 0 ?'active' :''}}">
                            ...
                            @endif
                          <div class="carousel-caption d-none d-md-block">
                            <h2 class="text-white">{{ ucwords($rankFiveProj->title) }}</h2>
                            @if(!Auth::guard('web')->check())
                    ...
                    @else
                        ...
                        <div class="carousel-item active">
                          ...
                          <div class="carousel-caption d-none d-md-block">
                             ...
                             <p class="text-secondary">Not Available Rank 5 Projects</p>
                          </div>
                       </div>
                    @endif  
                    </div>
