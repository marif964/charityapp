                        ...
                        <div class="card-body">
                            <form action="{{ route('update-profile') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col mr-2">
                                         <div class="mb-3"><label class="form-label" for="name">Name</label><input class="form-control" value="{{ $profile->fname.' '.$profile->lname }}" id="name" name="name" type="text" readonly=""></div>   
                                    </div>
