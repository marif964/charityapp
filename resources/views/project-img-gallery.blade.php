          ...
          <div class="row">
            <div class="col-md-12">
              <nav class="nav nav-pills nav-justified mt-3">
                <a class="nav-link " aria-current="page" href="{{ route('project-detail',['project_id' => $project->id]) }}">Story</a>
                <a class="nav-link active" href="{{ route('project-gallery',['project_id' => $project->id]) }}">Photos</a>
